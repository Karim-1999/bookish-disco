                ...
                <table>
                    ...
                    <?php while ($record = mysqli_fetch_assoc($result)) {  ?>
                        <tr>
                            ...
                            <td><?php /* echo substr($record['content'], 0, 250) . '...'; */ ?><?php echo substr(strip_tags($record['content']), 0, 130) . '...'; ?> </td>
                            <td><?php echo /*$record['Url-image']; */ substr($record['Url-image'], 0, 50) . '...'; ?> </td>
